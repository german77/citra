...
MiiResult MiiSelector::GetStandardMiiResult() {
    ...
    mii_data.mii_information.gender.Assign(0x0);
    mii_data.mii_information.birth_month.Assign(0x0);
    mii_data.mii_information.birth_day.Assign(0x0);
    mii_data.mii_information.favorite_color.Assign(0x0);
    mii_data.mii_information.favorite.Assign(0x0);
    ...
    mii_data.appearance_bits4.eye_type.Assign(0x2);
    mii_data.appearance_bits4.eye_color.Assign(0x0);
    mii_data.appearance_bits4.eye_scale.Assign(0x4);
    mii_data.appearance_bits4.eye_vertical_stretch.Assign(0x3);
    mii_data.appearance_bits4.eye_rotation.Assign(0x4);
    mii_data.appearance_bits4.eye_spacing.Assign(0x2);
    mii_data.appearance_bits4.eye_y_position.Assign(0xC);
    mii_data.appearance_bits5.eyebrow_style.Assign(0x6);
    mii_data.appearance_bits5.eyebrow_color.Assign(0x1);
    mii_data.appearance_bits5.eyebrow_scale.Assign(0x4);
    mii_data.appearance_bits5.eyebrow_yscale.Assign(0x3);
    mii_data.appearance_bits5.eyebrow_spacing.Assign(0x2);
    mii_data.appearance_bits5.eyebrow_y_position.Assign(0xA);
    mii_data.appearance_bits6.nose_type.Assign(0x1);
    mii_data.appearance_bits6.nose_scale.Assign(0x4);
    mii_data.appearance_bits6.nose_y_position.Assign(0x9);
    mii_data.appearance_bits7.mouth_type.Assign(0x17);
    mii_data.appearance_bits7.mouth_color.Assign(0x0);
    mii_data.appearance_bits7.mouth_scale.Assign(0x4);
    mii_data.appearance_bits7.mouth_horizontal_stretch.Assign(0x3);
    mii_data.appearance_bits8.mouth_y_position.Assign(0xD);
    mii_data.appearance_bits8.mustache_type.Assign(0x0);
    mii_data.allow_copying = 0x00;
    mii_data.appearance_bits9.bear_type.Assign(0x0);
    mii_data.appearance_bits9.facial_hair_color.Assign(0x0);
    mii_data.appearance_bits9.mustache_scale.Assign(0x4);
    mii_data.appearance_bits9.mustache_y_position.Assign(0xA);
    mii_data.appearance_bits10.glasses_type.Assign(0x0);
    mii_data.appearance_bits10.glasses_color.Assign(0x0);
    mii_data.appearance_bits10.glasses_scale.Assign(0x4);
    mii_data.appearance_bits10.glasses_y_position.Assign(0xA);
    mii_data.appearance_bits11.mole_enabled.Assign(0x0);
    mii_data.appearance_bits11.mole_scale.Assign(0x4);
    mii_data.appearance_bits11.mole_x_position.Assign(0x2);
    mii_data.appearance_bits11.mole_y_position.Assign(0x14);
